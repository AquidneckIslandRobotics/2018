...
public class SrxMotionProfileFollower {
	 ...
	 */
	public SrxMotionProfileFollower(TalonSRX talon, int PIDProfileSlot, SrxMotionProfile srxMotionProfile) {
		_talon = talon;
...
//			instrumentation.OnUnderrun();
		...
		for (int i = 0; i < totalCnt; ++i) {
			...
			point.timeDur.value = (int) profile[i][2];
			point.profileSlotSelect0 = _profileSelect; /* which set of gains would you like to use? */
