...
public class FollowTrajectory extends Command {
	...
	private class PeriodicRunnable implements java.lang.Runnable {
		public void run() {
			Robot.chassis.leftFront.processMotionProfileBuffer();
			Robot.chassis.rightFront.processMotionProfileBuffer();
		}
	}
	...
	protected void initialize() {
		...
		setUpTalon(Robot.chassis.rightFront);
		setUpTalon(Robot.chassis.leftFront);

		setValue = SetValueMotionProfile.Disable;
		
		Robot.chassis.rightFront.setInverted(false);
		Robot.chassis.rightTop.setInverted(false);
		Robot.chassis.rightBottom.setInverted(false);
		Robot.chassis.rightFront.setSensorPhase(false);
		
		Robot.chassis.leftFront.set(ControlMode.MotionProfile, setValue.value);
		Robot.chassis.rightFront.set(ControlMode.MotionProfile, setValue.value);
		...
		fillTalonBuffer(Robot.chassis.rightFront, this.trajectoryToFollow.rightProfile, pidfSlot);
		fillTalonBuffer(Robot.chassis.leftFront, this.trajectoryToFollow.leftProfile, pidfSlot);
	...
	protected void execute() {
		...
		Robot.chassis.rightFront.getMotionProfileStatus(rightStatus);
		Robot.chassis.leftFront.getMotionProfileStatus(leftStatus);
	...
	protected void end() {
		SrxNotifier.stop();
		resetTalon(Robot.chassis.rightFront, ControlMode.PercentOutput, 0);
		resetTalon(Robot.chassis.leftFront, ControlMode.PercentOutput, 0);
		Robot.chassis.rightFront.setInverted(true);
		Robot.chassis.rightTop.setInverted(true);
		Robot.chassis.rightBottom.setInverted(true);
		Robot.chassis.rightFront.setSensorPhase(true);
	}
