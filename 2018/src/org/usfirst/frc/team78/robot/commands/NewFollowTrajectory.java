...
public class NewFollowTrajectory extends Command {

	private BobTalonSRX rightTalon = (BobTalonSRX) Robot.chassis.rightFront;
	private BobTalonSRX leftTalon = (BobTalonSRX) Robot.chassis.leftFront;
	...
	// constructor
	public NewFollowTrajectory(String trajectoryName) {
		requires(Robot.chassis);
		this.trajectoryName = trajectoryName;
	}

	public NewFollowTrajectory(SrxTrajectory trajectoryToFollow) {
		requires(Robot.chassis);
